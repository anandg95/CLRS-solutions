...
class BST_SP(BST):
    def successor_inorder(self, node):
        """
        Cases:
    ...
    def predecessor_inorder(self, node):
        """
        Cases:
    ...
    def successor_preorder(self, node):
        """
        Cases:
    ...
    def predecessor_preorder(self, node):
        """
        Cases:
    ...
    def successor_postorder(self, node):
        """
        Cases:
    ...
    def predecessor_postorder(self, node):
        """
        Cases:
